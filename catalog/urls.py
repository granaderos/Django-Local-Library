...
urlpatterns = [
    ...
    path('transactions/', views.TransactionsListView.as_view(), name='transactions'),
    path(r'transaction/history?<s_id>', views.TransactionHistoryListView.as_view(), name='transaction-history'),
    path(r'transaction/create?<s_id>', views.create_new_transaction, name='transaction-create'),
