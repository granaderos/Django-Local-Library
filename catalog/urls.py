...
urlpatterns = [
    ...
    path('users', views.BorrowerListView.as_view(), name='users'),
    path('users/search_borrower', views.search_borrower, name='search_borrower'),
    path('librarians', views.LibrarianListView.as_view(), name='librarians'),
    path('librarians/search_librarian', views.search_librarian, name='search_librarian'),
